 ...
 public class SellingPrice{
   public static void main(String[] args) {
    ...
    // int combined_selling_price = 0;
     ...
     System.out.print("Enter number of products sold or -1 to quit:");
     ...
     //     double average_selling = (double) combined_selling_price / total_products_sold;
        ...
        System.out.printf("Total sales revenue is $%.2f%n", (double)total_sales_revenue);// Total sales revenue
        System.out.printf("Total number of products sold is %.2f%n", (double)total_products_sold);// Total number of products sold
